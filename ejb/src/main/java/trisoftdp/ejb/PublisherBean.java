...
public class PublisherBean  implements PublisherRemote{
	...
	public void process(long id, String configId, String contentDir,
		...
		System.out.println(" PublisherBean: process(long id, String configId, String contentDir,String configDir, DynamicPublishingPackage pack,Map<String, String> legend, String lang) called");
	...
	public long process(UserBean user, ProdEnvBean prodEnv, String lang) throws DynException, IOException {
		System.out.println(" PublisherBean: process(UserBean user, ProdEnvBean prodEnv, String lang) called");
